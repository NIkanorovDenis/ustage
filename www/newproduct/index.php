...
$APPLICATION->SetPageProperty("description", "В нашем интернет-магазине ustage-group.ru вы можете приобрести {=lower this.Name} по выгодной цене и доставкой по всей России");
$APPLICATION->SetPageProperty("title", "{=this.Name} купить в Санкт-Петербурге по доступной цене в Ustage Group");
