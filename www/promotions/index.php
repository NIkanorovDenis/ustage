...
$APPLICATION->SetPageProperty("keywords", "акции, шоу-техники");
$APPLICATION->SetPageProperty("title", "Выгодные предложения в Санкт-Петербурге на шоу технику от компании Ustage Group");
    $APPLICATION->SetPageProperty("description", "Выгодные предложения и скидки на оборудование и шоу технику в интернет магазине Ustage Group. Акции при покупке светового и музыкального оборудования в Санкт-Петербурге.");
    $APPLICATION->SetTitle("Выгодные предложения");
?>
<?
global $arrFilter;
$arrFilter = array(
