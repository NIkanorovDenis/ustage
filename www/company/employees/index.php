...
$APPLICATION->SetPageProperty("description", "Наши незаменимые сотрудники и профессионалы своего дела!");
$APPLICATION->SetTitle("Наши сотрудники");
?><div class="tb20-bottom">Компания специализируется на предоставлении услуг как для корпоративных клиентов так и для частных лиц.  Деятельность 
компании получила высокую оценку профессионального сообщества.</div><br><br>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"BXREADY_ELEMENT_DRAW" => "employees.v1",
