...
$APPLICATION->SetPageProperty("title", "Лицензии и сертификаты компании Ustage Group ");
$APPLICATION->SetPageProperty("description", "Сертификаты и лицензии, подтверждающие нашу компетентность");
$APPLICATION->SetTitle("Лицензии и сертификаты");
?><h4>Сертификаты официального представителя</h4>
 <br>
