...
$APPLICATION->SetPageProperty("description", "Успей купить, специальные предложения");
$APPLICATION->SetPageProperty("title", "Успей купить");
$APPLICATION->SetTitle("Успей купить");?>
<?
global $arrFilter;
$arrFilter = array(
	//">=PROPERTY_BXR_DISCOUNT_PERIOD_FROM" => ConvertTimeStamp(time(),"FULL"),
	">=PROPERTY_BXR_DISCOUNT_PERIOD_TO"   => date( 'Y-m-d H:i:s' ),
	//"!PROPERTY_BXR_DISCOUNT_TIMER" => false
);
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"BXREADY_LIST_OWN_MARKER_USE_LISTPAGE" => "Y",
