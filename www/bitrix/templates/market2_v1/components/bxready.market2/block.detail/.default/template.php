...
<div class="bxr-element-detail tb20-bottom">
    <div class="row">
		...
		<? if (isset($arResult["PROPERTIES"]["ADD_CLASS"]) && $arResult["PROPERTIES"]["ADD_CLASS"]["VALUE"]=="SIMPLE_MODE" ): ?>
		
			<div class="bxr-element-detail_block">
				<div class="bxr-element-detail_left">
				
					<div class="bxr-element-date-wrap">
						<?
				...
				<div class="bxr-element-detail_right">
		...
		<? else: ?>
			...
			<?else:?>
				...
				<div class="col-xs-12<?=((count($arResult["IMAGES"]) > 0 || !empty($arResult["DETAIL_PICTURE"])) && empty($arResult['PROPERTIES']['SLICK']['VALUE'])) ? " col-md-7" : ""?>">
					<?
					$elementarArea = \Alexkova\Bxready2\Elementars::getArea('block.detail','slider');
					if (strlen($elementarArea) > 0)
						include($elementarArea);
				...
				<div class="col-xs-12<?=(count($arResult["IMAGES"]) > 0 || !empty($arResult["DETAIL_PICTURE"])) ? " col-md-5" : ""?> bxr-element-right-col">
					<? if ($preview_date): ?>
						<div class="pull-left bxr-element-date-wrap">
							<?
							$elementarArea = \Alexkova\Bxready2\Elementars::getArea('block.detail','date');
