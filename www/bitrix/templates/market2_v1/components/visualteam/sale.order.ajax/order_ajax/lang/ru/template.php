...
$MESS["SOA_ERROR_ORDER_"] = "Ошибка формирования заказа";
$MESS["SOA_ERROR_ORDER_LOST"] = "Заказ №#ORDER_ID# не найден.";
$MESS["SOA_ERROR_ORDER_LOST_"] = "Заказ №#ORDER_ID# не найден.";
...
$MESS["SOA_ERROR_ORDER_LOST1_"] = "Пожалуйста обратитесь к администрации интернет-магазина или попробуйте оформить ваш заказ еще раз.";
...
$MESS["SOA_ORDER_COMPLETE"] = "Оформление заказа";
...
$MESS["ORDER_DESC_DEFAULT"] = "Комментарии к заказу (необязательно):";
