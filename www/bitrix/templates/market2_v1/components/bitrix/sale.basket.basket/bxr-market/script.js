			...
			for (i = 0; i < arColumns.length; i++)
			{
				switch (arColumns[i])
				{
					...
					case 'NAME':
						...
						if (arItem['DETAIL_PAGE_URL'].length > 0)
							cellItemHTML += '<div class="h2 bx_ordercart_itemtitle"><a href="' + arItem['DETAIL_PAGE_URL'] + '">' + arItem['NAME'] + '</a></div>';
						else
							cellItemHTML += '<div class="h2 bx_ordercart_itemtitle">' + arItem['NAME'] + '</div>';
									...
									if (bIsImageProperty)
									{
										...
										for (valueId in arProp['VALUES'])
										{
											...
											cellItemHTML += '<li style="width:10%;"\
															...
															>\
															<a href="javascript:void(0)" class="cnt' + selectedChild + '"><span class="cnt_item" style="background-image:url(' + arSkuValue['PICT']['SRC'] + '"></span></a>\
														</li>';
										}
									...
									else // not image
									{
										...
										for (valueId in arProp['VALUES'])
										{
											...
											cellItemHTML += '<li style="width:10%;"\
															...
															data-property="' + arProp['CODE'] + '" \
															>\
															<a href="javascript:void(0)" class="cnt' + selectedChild + '">' + BX.util.htmlspecialchars(arSkuValue['NAME']) + '</a>\
														</li>';
										}
					...
					case 'QUANTITY':
						...
						oCellQuantityHTML += '<td><div class="bxr-basket-qty">';
						...
						oCellQuantityHTML += '<input class="bxr-quantity-text-big-basket" type="text" size="3" id="QUANTITY_INPUT_' + arItem['ID'] + '"\
						...
						>';
                                                ...
                                                if (ratio != 0 && ratio != '')
                                                    oCellQuantityHTML += '<a href="javascript:void(0);" class="plus bxr-quantity-button-plus-big-basket" onclick="setQuantity(' + arItem['ID'] + ', ' + ratio + ', \'up\', ' + bUseFloatQuantity + ');">+</a>';


						oCellQuantityHTML += '</div></td>';
