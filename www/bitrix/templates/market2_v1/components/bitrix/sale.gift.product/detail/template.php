...
if (!empty($arResult['ITEMS']))
{
    ...
    <div class="h3 bxr-gift-title"><?=$arParams["BLOCK_TITLE"]?></div>
	<div class="bx_item_list_gift_horizontal col<?=$arParams['LINE_ELEMENT_COUNT'];?><?=($arParams['TAB_POSITION'] == 'bottom')?' bxr-gift-bottom':''?>">
            <div class="bx_item_list_section">
                ...
                ?>
                    <div class="bxr-ecommerce-gift" id="<? echo $strMainID; ?>" data-resize="1" data-uid="1">
