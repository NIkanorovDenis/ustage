...
?>
<div class="sale-profile-detail-link-list bxr-border-color">
...
<div class="row">
	...
	<form method="post"  class="sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="sale-personal-profile-detail-form-label"><div class="h4"><?=Loc::getMessage('SALE_PERS_TYPE')?></div></label>
			<div class="">
