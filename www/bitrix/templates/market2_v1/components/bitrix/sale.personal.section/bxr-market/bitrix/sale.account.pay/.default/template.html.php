...
<!---->
	<div class="bx-sap">
		<div class="h2-personal">Пополнение счета</div>

		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12 bx-sap-block">
					<div class="h3 bx-sap-title">Фиксированный платеж</div>
			...
			<div class="row">
				<div class="col-xs-12 bx-sap-block form-horizontal">
					<div class="h3 bx-sap-title">Сумма</div>
			...
			<div class="row">
				<div class="col-xs-12 bx-sap-block">
					<div class="h3 bx-sap-title">Метод оплаты</div>
					<div>
