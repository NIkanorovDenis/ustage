        ...
        <div class="col-xs-12 col-sm-6">
            <form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form">
                    ...
                    <div class="main-profile-block-shown" id="user_div_reg">
                            ...
                            <div class="form-group">
                                    <label class="main-profile-form-label " for="main-profile-email"><?=Loc::getMessage('EMAIL')?><?=($arResult["EMAIL_REQUIRED"])?"<span class='required'> *</span>":""?></label>
                                    <div>
                    ...
                    <p class="main-profile-form-buttons-block ">
                            <input type="submit" name="save" class="btn bxr-color-button main-profile-submit" value="<?=(($arResult["ID"]>0) ? Loc::getMessage("SAVE") : Loc::getMessage("MAIN_ADD"))?>">
                            &nbsp;
                            <input type="submit" class="btn bxr-color-button"  name="reset" value="<?echo GetMessage("MAIN_RESET")?>">
                            <span class="required-mess"><span class="required">*</span> <?=GetMessage("REQUIRED_MESS")?></span>
                    </p>
            </form>
        </div>
