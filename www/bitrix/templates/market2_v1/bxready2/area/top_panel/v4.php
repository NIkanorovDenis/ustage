...
<div class="bxr-upper-part bxr-cloud-all bxr-cloud-all-br3-not bxr-cloud-all-br4-not">
    <div class="row">
        <div class="col-xl-8 col-xs-5 bxr-element-row-middle">
            <div class="bxr-element-col-middle bxr-socnet-container visible-xl-table-cell hidden-lg hidden-md hidden-xs  hidden-sm">
        ...
        <div class="col-xl-4 col-xs-7 text-right">
...
<?$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/bxready2/area/top_panel/v4/style.css", true);?>