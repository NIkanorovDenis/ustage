...
?>
<div class="bxr-full-width bxr-color-line footer-head-v0 footer-head-v1 container bxr-bg-container <?=$bxmarket->getCoreData("xl_class");?>">
    <div class="row">
...
<?
$APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/bxready2/area/footer/v1/style.css", true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/bxready2/area/footer/v1/script.js");
?>
