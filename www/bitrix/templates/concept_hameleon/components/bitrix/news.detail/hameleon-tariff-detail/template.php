...
<?
	...
	if(!empty($arResult["PROPERTIES"]["TARIFF_INCLUDE"]["VALUE"]) || !empty($arResult["PROPERTIES"]["TARIFF_INCLUDE"]["VALUE"]) || strlen($arResult["PROPERTIES"]["TARIFF_PRICE"]["VALUE"]) > 0 || strlen($arResult["PROPERTIES"]["TARIFF_OLD_PRICE"]["VALUE"]) > 0 || strlen($arResult["PROPERTIES"]["TARIFF_BUTTON_NAME"]["VALUE"]) > 0)
		$right = true;
		    ...
		    <div class="info-table">
				...
				<?if(strlen($arResult["PROPERTIES"]["TARIFF_PICTURE"]["VALUE"]) > 0):?>
			        ...
			        <div class="info-cell image-wrap hidden-xs">
			        	...
			        	<img alt="<?=$arResult["PROPERTIES"]["TARIFF_NAME"]["~VALUE"]?>" class="img-responsive" src="<?=$img["src"]?>" />
			        </div>
			...
			<div class="row">
				...
				<div class="tariff-container-inner">
					...
					<?if($left):?>
						...
						<div class="<?if($right):?>col-lg-8 col-md-8 col-sm-8 col-xs-12<?else:?>col-lg-12 col-md-12 col-sm-12 col-xs-12<?endif;?> tariff-container-inner-cell left">
			        ...
			        <?if($right):?>
				        ...
				        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 tariff-container-inner-cell right">

				        	<div class="part-wrap">
				        	

					        	<?if(!empty($arResult["PROPERTIES"]["TARIFF_INCLUDE"]["VALUE"]) || !empty($arResult["PROPERTIES"]["TARIFF_INCLUDE"]["VALUE"])):?>
					        	...
					        	<?if(strlen($arResult["PROPERTIES"]["TARIFF_BUTTON_NAME"]["VALUE"]) > 0):?>
							        ...
							        <div class="button-wrap">
							            ...
							            <a class="button-def primary big from-modal from-tariff more-modal-info <?=$arResult["SECTION_MAIN"]["ITEMS"]["UF_CHAM_BUTTONS_TYPE_ENUM"]["XML_ID"]?> <?=ChamDB::hamButtonEditClass ($arResult["PROPERTIES"]["TARIFF_BUTTON_TYPE"]["VALUE_XML_ID"], $arResult["PROPERTIES"]["TARIFF_BUTTON_FORM"]["VALUE"], $arResult["PROPERTIES"]["TARIFF_MODAL"]["VALUE"])?>" data-element-type = "TRF" <?=ChamDB::hamButtonEditAttr($arResult["PROPERTIES"]["TARIFF_BUTTON_TYPE"]["VALUE_XML_ID"], $arResult["PROPERTIES"]["TARIFF_BUTTON_FORM"]["VALUE"], $arResult["PROPERTIES"]["TARIFF_MODAL"]["VALUE"], $arResult["PROPERTIES"]["TARIFF_BUTTON_LINK"]["VALUE"], $arResult["PROPERTIES"]["TARIFF_BUTTON_BLANK"]["VALUE_XML_ID"], htmlspecialcharsEx(strip_tags(html_entity_decode($arParams["CHAM_HEADER"]))), $arResult["PROPERTIES"]["TARIFF_BUTTON_QUIZ"]["VALUE"], $arResult["ID"])?>><?if(strlen($arResult["PROPERTIES"]["TARIFF_BUTTON_NAME"]["VALUE"]) > 0):?><?=$arResult["PROPERTIES"]["TARIFF_BUTTON_NAME"]["~VALUE"]?><?endif;?></a>
