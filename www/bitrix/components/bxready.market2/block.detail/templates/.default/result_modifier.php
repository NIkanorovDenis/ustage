...
if (
	...
	$sizeMatrix = $arParams['BXR_PICTURE']['BXR_DETAIL_PICTURE_TYPE'] == 'fullsize_slider' ? array('width'=>1084, 'height'=>$arParams['BXR_PICTURE']['BXR_SLIDER_HEIGHT']) : array('width'=>620, 'height'=>375);
...
if ($arParams["BXR_DETAIL_TABS"]['BXR_DETAIL_TAB_VIDEO'] == "Y"){
	...
	if (is_array($arResult['PROPERTIES']['BXR_VIDEO']['VALUE']) && count($arResult['PROPERTIES']['BXR_VIDEO']['VALUE'])>0 && !empty($arResult['PROPERTIES']['BXR_VIDEO']['VALUE'][0])){
