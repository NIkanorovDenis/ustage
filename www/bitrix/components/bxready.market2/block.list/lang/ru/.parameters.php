...
$MESS["ADDITIONAL_PARAMS"] = "Массив, в котором содержатся дополнительные параметры настройки показа";
$MESS["PAGE_BLOCK_TITLE"] = "Подзаголовок для блока (не заполнйте, если подзаголовок не нужно выводить)";
$MESS["PAGE_BLOCK_TITLE_GLYPHICON"] = "Glyphicon для подзаголовка (не заполнять, если glyphicon не требуется)";
$MESS["BXREADY_LIST_COLLECTION2_STYLE"] = "Использовать BXReady 2.0";
