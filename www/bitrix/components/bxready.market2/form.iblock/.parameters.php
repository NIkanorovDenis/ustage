...
if(!CModule::IncludeModule("iblock") || !CModule::IncludeModule("alexkova.market2"))
	return;
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
                "IGNORE_GLOBAL_PARAMS" => array(
                        "PARENT" => "BASE",
                        "NAME" => GetMessage("KZNC_IGNORE_GLOBAL"),
                        "TYPE" => "CHECKBOX",
                ),
		"IBLOCK_TYPE" => array(
			"PARENT" => "DATA_SOURCE",
...
$arComponentParameters["PARAMETERS"]["BXR_FORM_ID"] = array(
	"PARENT" => "PARAMS",
...
$arComponentParameters["PARAMETERS"]['BXR_FORM_SUBMIT_ICON'] = array(
