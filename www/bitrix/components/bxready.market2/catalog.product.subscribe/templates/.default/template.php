...
<span id="<?=htmlspecialcharsbx($arResult['BUTTON_ID'])?>"
	...
	<span>
            <?=(strlen($arParams["MESS_BTN_SUBSCRIBE"]) > 0) ? $arParams["MESS_BTN_SUBSCRIBE"] : Loc::getMessage('CPST_SUBSCRIBE_BUTTON_NAME');?>
	</span>
</span>
...
<script type="text/javascript">
	BX.message({
		...
		CPST_SUBSCRIBE_BUTTON_NAME: '<?=(strlen($arParams["MESS_BTN_SUBSCRIBE"]) > 0) ? $arParams["MESS_BTN_SUBSCRIBE"] : Loc::getMessage('CPST_SUBSCRIBE_BUTTON_NAME');?>',
