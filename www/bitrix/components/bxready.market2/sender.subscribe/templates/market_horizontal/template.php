                    ...
                    <div class="row">
                        <div class="col-md-4 bxr-subscribe-motto">
                            ...
                            <div class="bxr-subscribe-text">
                                <b><?=GetMessage("stay_touch")?></b><br><br>
                                    ...
                                    <?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
                                        <li>
                                            <div class="bxr-personal-accept bxr-checkbox">
                                                ...
                                                <label class="bxr-label" for="SENDER_SUBSCRIBE_RUB_ID_<?=$itemValue["ID"]?>"><?=htmlspecialcharsbx($itemValue["NAME"])?></label>
                                            </div>
                                        </li>
                                    <?endforeach;?>
                                </ul></div>
                        ...
                        <div class="col-md-3 bxr-input-group">
                            <input class="bxr-form-control bxr-border-color-focus" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
                        </div>
