...
$commonListParams = array(
    "LINE_ELEMENT_COUNT" => $arParams["BIG_DATA_CNT_DETAIL"],
    ...
    "PAGE_ELEMENT_COUNT" => $arParams["BIG_DATA_CNT_DETAIL"],
    "SHOW_FROM_SECTION" => "N",
    ...
    "RCM_TYPE" => (isset($arParams["BIG_DATA_RCM_TYPE_DETAIL"]) ? $arParams["BIG_DATA_RCM_TYPE_DETAIL"] : ""),
    "BLOCK_TITLE" => $arParams["BIG_DATA_TITLE_DETAIL"],
