...
?>
<div class="bxr-show-filter-btn"><span><?=GetMessage("SHOW_FILTER")?></span><i class="fa fa-angle-down"></i></div>
...
//                                        || !in_array($arItem["CODE"],$arParams['FILTER_PRICE_CODE'])
                                        )
					continue;// include/icons.php

				$key = $arItem["ENCODED_ID"];
				if(isset($arItem["PRICE"])):
					if (!isset($arItem["VALUES"]["MIN"]["VALUE"]) || !isset($arItem["VALUES"]["MAX"]["VALUE"]) || $arItem["VALUES"]["MIN"]["VALUE"] == $arItem["VALUES"]["MAX"]["VALUE"])
						continue;
					?>
						...
						<div class="bx_filter_block" data-role="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
									...
									<div class="bx_ui_slider_pricebar_V bxr-color bx_ui_slider_range"  style="left: 0;right: 0;" id="colorAvailableActive_<?=$key?>"></div>
									<div class="bx_ui_slider_range" id="drag_tracker_<?=$key?>"  style="left: 0%; right: 0%;">
											</div>
									<a class="bx_ui_slider_handle bxr-border-color left"  style="left:0;" href="javascript:void(0)" id="left_slider_<?=$key?>"></a>
									<a class="bx_ui_slider_handle bxr-border-color right" style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>"></a>
				...
				<div class="bx_filter_parameters_box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
					...
					<div class="bx_filter_parameters_box_title" data-role="prop_angle"  onclick="smartFilter.hideFilterProps(this)">
                                            ...
                                            <?if ($arItem["FILTER_HINT"] <> ""):?>
                                                <i id="item_title_hint_<?echo $arItem["ID"]?>" class="fa fa-question-circle bxr-color"></i>
                                                <script type="text/javascript">
                                                        new top.BX.CHint({
						...
						switch ($arItem["DISPLAY_TYPE"])
						{
							case "A"://NUMBERS_WITH_SLIDER
								...
								<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
									<div class="bx_ui_slider_pricebar_VD" style="left: 0;right: 0;" id="colorUnavailableActive_<?=$key?>"></div>
									<div class="bx_ui_slider_pricebar_VN" style="left: 0;right: 0;" id="colorAvailableInactive_<?=$key?>"></div>
									<div class="bx_ui_slider_pricebar_V bxr-color"  style="left: 0;right: 0;" id="colorAvailableActive_<?=$key?>"></div>
							...
							case "K"://RADIO_BUTTONS
								...
								<label class="bx_filter_param_label" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
									<span class="bx_filter_input_checkbox">
										...
										/>
                                                                                <span class="bxr-filter-input bxr-filter-radio<?=($ar["CHECKED"])?" checked bxr-color bxr-border-color":""?>"></span>
									...
									<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
										<span class="bx_filter_input_checkbox">
											<input
												...
												onclick="smartFilter.click(this)"
											/>
                                                                                        <span class="bxr-filter-input bxr-filter-checkbox<?=($ar["CHECKED"])?" checked bxr-color bxr-border-color":""?>"></span>
											<span class="bx_filter_param_text"><? echo $ar["VALUE"]; ?><?
                                                                                        if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                                                                ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                                                                                        endif;?></span>
