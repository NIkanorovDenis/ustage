...
$arComponentParams = array(
	...
	"BXREADY_LIST_XLG_CNT" => $currentParams["BXREADY_LIST_XLG_CNT"],
    ...
    "BXREADY_LIST_SLIDER_AUTOSCROLL" => $currentParams["BXREADY_LIST_SLIDER_AUTOSCROLL"],
...
if ($arParams["BXR_USE_RELATED_ELEMENTS"] == "Y") {
