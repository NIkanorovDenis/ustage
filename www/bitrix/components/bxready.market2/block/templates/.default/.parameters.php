...
$arTemplateParameters = array(
	...
	"DETAIL_ADD_ELEMENT_CHAIN" => array(
        "PARENT" => "DETAIL_SETTINGS",
        "NAME" => GetMessage("DETAIL_ADD_ELEMENT_CHAIN"),
        "TYPE" => "CHECKBOX",
        "DEFAULT" => "Y",
    ),
...
$arTemplateTypes = array(
    "default" => GetMessage("BXR_TEMPLATE_DEFAULT"),
    "duplex" => GetMessage("BXR_TEMPLATE_DUPLEX"),
    "list" => GetMessage("BXR_TEMPLATE_LIST"),
);

$arTemplateParameters["BXR_TEMPLATE_TYPE"] = array(
    "NAME" => GetMessage("BXR_TEMPLATE_TYPE"),
    "PARENT" => "BASE",
    "TYPE" => "LIST",
    "VALUES" => $arTemplateTypes,
...
if (CModule::IncludeModule('alexkova.bxready2')){
    ...
    $arCollectionNews = ($arCurrentValues["BXR_TEMPLATE_TYPE"] == 'default') ? array('news.horizontal.v1', 'news.vertical.v1') : array('news.horizontal.v1');
