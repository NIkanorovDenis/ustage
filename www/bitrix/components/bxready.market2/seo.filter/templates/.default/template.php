...
<div class="bx-filter bx-filter-horizontal">
	...
	<h3><?=GetMessage("CT_FILTER_TITLE")?></h3>
...
<script type="text/javascript">
	var smartFilter = new JCSmartFilter('<?echo CUtil::JSEscape($arResult["FORM_ACTION"])?>', 'HORIZONTAL', <?=CUtil::PhpToJSObject($arResult["JS_FILTER_PARAMS"])?>, '<?=$arParams['OPENER']?>');
</script>