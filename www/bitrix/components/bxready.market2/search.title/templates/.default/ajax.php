...
if (empty($arResult["CATEGORIES"]))
	return;
?>
<div class="bx_searche bxr-title-search-result">
		...
		<?if($category_id === "all"):?>
			<div class="bx_item_block bx_item_block_el  all_result">
				<div class="bx_item_element">
					<span class="all_result_title"><a href="<?echo $arItem["URL"]?>"><i class="fa fa-search-plus" aria-hidden="true"></i><?echo $arItem["NAME"]?></a></span>
				</div>
