...
if(\Bitrix\Main\Loader::includeModule("alexkova.bxready2"))
    \Alexkova\Bxready2\Component::prepareParams($arParams, "bxready.market2:menu.sections");
...
if($this->StartResultCache())
{
    ...
    else
    {
        ...
        {
			if (isset($arSection["UF_BXR_SEO_SECTION"]) && $arSection["UF_BXR_SEO_SECTION"] && !$arSection["UF_BXR_SEO_NAV"]) {
				continue ;
			}
            ...
            $arResult["SECTIONS"][] = array(
                ...
                "UF_SHOW_IN" => ($arSection["UF_SHOW_IN"]==1) ? "Y" : "N",
                "~NAME" => $arSection["~NAME"],
