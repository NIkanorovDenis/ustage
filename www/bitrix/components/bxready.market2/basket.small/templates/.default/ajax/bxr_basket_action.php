...
try
{
    $template = $signer->unsign($request->get('template'), 'basket');
    $paramString = $signer->unsign($request->get('parameters'), 'basket');
}
...
$APPLICATION->IncludeComponent("bxready.market2:basket.small", $template, $parameters);
