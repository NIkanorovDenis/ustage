...
\Alexkova\Bxready2\Component::prepareParams($arParams, "bxready.market2:catalog.section.tree");
...
if($this->startResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	if(is_array($arResult["SECTION"]))
	{
		...
		$arResult["SECTION"]["IPROPERTY_VALUES"] = \Alexkova\Market2\Bxmarket::replaceRegionMegaTags($ipropValues->getValues());
		...
		while($arPath = $rsPath->GetNext())
		{
			...
			$arPath["IPROPERTY_VALUES"] = \Alexkova\Market2\Bxmarket::replaceRegionMegaTags($ipropValues->getValues());
	...
	while($arSection = $rsSections->GetNext())
	{
		...
		$arSection["IPROPERTY_VALUES"] = \Alexkova\Market2\Bxmarket::replaceRegionMegaTags($ipropValues->getValues());
                $arSection["DESCRIPTION"] = \Alexkova\Market2\Bxmarket::replaceRegionMegaTags($arSection["DESCRIPTION"]);
