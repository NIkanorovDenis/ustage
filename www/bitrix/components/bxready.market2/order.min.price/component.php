...
if (!CModule::IncludeModule('alexkova.market2') || !CModule::IncludeModule("sale"))  return;
...
$arResult["MIN_ORDER_PRICE"] = COption::GetOptionString($module_id, "bxr_min_order_price");
$arResult["MIN_ORDER_PRICE_FORMATED"] = str_replace('#', $arResult["MIN_ORDER_PRICE"], $arResult["CURRENCY_FORMAT"]);
$arResult["ADD_PRICE"] = round(floatval($arResult["MIN_ORDER_PRICE"]) - $arOrder["ORDER_PRICE"], 2);
$arResult["ADD_PRICE_FORMATED"] = str_replace('#', $arResult["ADD_PRICE"], $arResult["CURRENCY_FORMAT"]);
$optionMsg = COption::GetOptionString($module_id, "bxr_min_order_price_msg");
