	...
	"GROUPS" => array(
		"CACHE_SETTINGS" => array(
			...
			"SORT" => 600
                ...
                "MENU_USER" => array('NAME'=>GetMessage("MENU_USER"), "SORT" => "500"),
                "MENU_COMPARE" => array('NAME'=>GetMessage("MENU_COMPARE"), "SORT" => "500"),
                "MENU_FAVORITES" => array('NAME'=>GetMessage("MENU_FAVORITES"), "SORT" => "510"),
                "MENU_BASKET" => array('NAME'=>GetMessage("MENU_BASKET"), "SORT" => "520"),
	),
	"PARAMETERS" => array(
