...
<div class='bxr-form-body-container'>
	...
	<div class="request-product">    
		<div class="request-product-img bxr-hidden">
			<img alt="" src="<?=$_REQUEST['PRODUCT_IMG'];?>">
		</div>    
		<div class="request-product-name"><?=$_REQUEST['PRODUCT_NAME'];?></div> 
	</div>
	...
	<form id="<?=$arParams['IDENTITY']?>" class='bxr-form-body roxy4 request_product' name="iblock_add" action="<?=$arParams["POST_FORM_URI"]?>" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="PRODUCT_IMG" value="<?=$_REQUEST['PRODUCT_IMG'];?>"/>
		...
		<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
			...
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
				...
				<? if (substr_count($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"], 'HIDDEN') > 0) {
					...
					$inputType = 'textarea';
				} elseif (substr_count($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"], '_MAIL') > 0) {
					$inputType = 'email';
				} else {
					$inputType = 'text';
				}?>
