                    ...
                    <form id="bxr-one-click-order-form" class="bxr-form-body" name="bxrOneClickOrderForm" action="<?=$this->GetFolder()?>/ajax.php" method="post" enctype="multipart/form-data">
                        ...
                        <?if ($arResult['USE_PERSONAL_ACCEPT']):?>
                            <div class="bxr-personal-accept bxr-checkbox">
                                ...
                                <label class="bxr-label" for="accept_form_one_click_order"><?=$arResult['PERSONAL_SETTINGS']['CAPTION']?> (<a href="<?=$arResult['PERSONAL_SETTINGS']['URL']?>" target="_blank"><?=$arResult['PERSONAL_SETTINGS']['ACCEPT_DOCUMENT']?></a>)</label>
                            </div>            
			<?endif;?>
