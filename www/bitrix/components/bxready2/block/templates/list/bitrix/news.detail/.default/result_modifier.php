...
if (
	...
	$sizeMatrix = $arParams['BXR_PICTURE']['BXR_DETAIL_PICTURE_TYPE'] == 'fullsize_slider' ? array('width'=>1084, 'height'=>$arParams['BXR_PICTURE']['CBXR_PICTURE_BXR_SLIDER_HEIGHT']) : array('width'=>500, 'height'=>375);
