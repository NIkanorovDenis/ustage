				...
				<div class="bx_item_block">
					<div class="bx_item_element">
						<div class="bx_img_element">
							...
							<?else:?>
								<a href="<?echo $arItem["URL"]?>"><img class="bx_image" src="/bitrix/components/visualteam/search.title/templates/.default/images/noimg.png" alt="" title=""/></a>
							<?endif;?>
						</div>
		...
		<?foreach($arCategory["ITEMS"] as $i => $arItem):?>
			...
			elseif(isset($arResult["ELEMENTS"][$arItem["ITEM_ID"]]) || isset($arResult["SECTIONS"][$arItem["ITEM_ID"]])):
				...
				<div class="bx_item_block others_result">
					<div class="bx_item_element">
						<div class="bx_img_element">
							<img class="bx_image" src="/bitrix/components/visualteam/search.title/templates/.default/images/noimg.png" alt="" title=""/>
						</div>
