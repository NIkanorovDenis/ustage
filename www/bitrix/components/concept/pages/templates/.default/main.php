...
<?
$host = ChamHost::ChamHostFunc($_SERVER["HTTP_HOST"]);
...
<?
$arFilter2 = Array('IBLOCK_ID'=>$arParams["IBLOCK_ID"], "ACTIVE"=>"Y", "=UF_CHAM_URL" => $host);
...
else
{
    ...
    if(strlen($ar_result["UF_CHAM_URL"]) > 0 && $ar_result["UF_CHAM_URL"] != $host)
